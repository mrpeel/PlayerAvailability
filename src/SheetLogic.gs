 ...
 * Switchers 50px, Notes 143px, Names 153px, Notes font size 9pt.
 */
function applyRoundTabColumnWidths(ws) {
  ...
  ws.setColumnWidth(6, 80);  ws.setColumnWidth(7, 153); ws.setColumnWidth(8, 143); ws.setColumnWidth(9, 50); ws.setColumnWidth(10, 20);
  ws.setColumnWidth(11, 80); ws.setColumnWidth(12, 153); ws.setColumnWidth(13, 143); ws.setColumnWidth(14, 50); ws.setColumnWidth(15, 20);
  ws.setColumnWidth(16, 80); ws.setColumnWidth(17, 153); ws.setColumnWidth(18, 143); ws.setColumnWidth(19, 50); ws.setColumnWidth(20, 20);
